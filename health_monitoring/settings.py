...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-s_mq*su$7n(mho-^z942&&$^vw4cw-z^8*tj^e%(r$x%0)*(2*')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'monitoring.context_processors.active_device',
            ],
        },
    },
]
...
# Database configuration untuk PythonAnywhere MySQL
